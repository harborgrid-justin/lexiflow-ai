/**
 * DiscoveryPlatformPage - Discovery Center Page Component
 *
...
import { PageHeader, Button, TabNavigation, TabItem } from '@/components/common';
import {
...
import type { DiscoveryView } from '../api/discovery.types';
...
export const DiscoveryPlatformPage: React.FC = () => {
  ...
  const showHeader = ['dashboard', 'requests', 'privilege', 'holds', 'plan'].includes(view);
          ...
          <PageHeader
            ...
            actions={
              <div className="flex gap-2">
                <Button variant="secondary" icon={Clock} onClick={() => alert('Syncing Court Deadlines...')}>
                  Sync Deadlines
                </Button>
                <Button variant="primary" icon={Plus} onClick={() => alert('New Request Wizard')}>
                  Create Request
                </Button>
              </div>
            }
...
export default DiscoveryPlatformPage;
