/**
 * AnalyticsDashboardPage - Feature Module Page
 *
 ...
 * - useTrackEvent for analytics tracking on tab changes
 * - usePageView for page tracking
 * - HydrationBoundary for progressive hydration of analytics sub-components
...
const JudgeAnalytics = lazy(() =>
  import('@/components/analytics/JudgeAnalytics').then(m => ({ default: m.JudgeAnalytics }))
);
const CounselAnalytics = lazy(() =>
  import('@/components/analytics/CounselAnalytics').then(m => ({ default: m.CounselAnalytics }))
);
const CasePrediction = lazy(() =>
  import('@/components/analytics/CasePrediction').then(m => ({ default: m.CasePrediction }))
);
